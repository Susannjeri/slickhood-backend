...
class AccountActivationFilterTest {
    ...
    @BeforeEach void setUp() {
        ...
        filter = new AccountActivationFilter(users, mock(I18NService.class), new ObjectMapper());
    ...
    @Test void approvedCustomerCanCallOperationalApi() throws Exception {
        Users user = new Users(); user.setAccountStatus(AccountStatus.ACTIVE.name());
    ...
    private void pendingCustomer(PMSRole role) {
        Users user = new Users(); user.setAccountStatus(AccountStatus.PENDING_KYC.name());
