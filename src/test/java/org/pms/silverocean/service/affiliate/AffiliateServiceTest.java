...
class AffiliateServiceTest {
    ...
    void paidReferredSubscriptionCreatesPendingCommissionOnce() {
        ...
        when(commissions.findAllByReferredUserIdAndActiveTrueOrderByEarnedAtAsc(8L)).thenReturn(List.of());
        ...
        verify(commissions).save(argThat(c ->
                c.getCommissionAmount().compareTo(BigDecimal.valueOf(350).setScale(2)) == 0
    ...
    private static AffiliateProfile profile() {
        ...
        profile.setCommissionRate(BigDecimal.TEN);
