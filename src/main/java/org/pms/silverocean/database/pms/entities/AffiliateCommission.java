...
@Entity
@Table(name="pms_affiliate_commission", indexes={
        @Index(name="idx_commission_affiliate", columnList="affiliateUserId,status"),
        @Index(name="idx_commission_invoice", columnList="invoiceId", unique=true)})
