...
public interface WealthVaultDocumentRepo extends JpaRepository<WealthVaultDocument,Long>{
 List<WealthVaultDocument> findAllByAssetIdAndActiveTrueOrderByCreatedOnDesc(long assetId);
 List<WealthVaultDocument> findAllByOwnerUserIdAndActiveTrueOrderByCreatedOnDesc(long ownerUserId);
