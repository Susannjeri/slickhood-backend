...
public class HelpDeskController {
    ...
    @PostMapping("/admin/articles/manual-drafts") @PreAuthorize("hasAuthority('manage_helpdesk_articles')") public ResponseEntity<ResponseDTO> importManual(){return ok(service.importManualDrafts());}
