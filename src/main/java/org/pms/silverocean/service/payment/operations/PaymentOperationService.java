...
public class PaymentOperationService {
    ...
    private final FinancialLedgerService ledger; private final UserDao users; private final AffiliateService affiliates; private final SokoService soko;
