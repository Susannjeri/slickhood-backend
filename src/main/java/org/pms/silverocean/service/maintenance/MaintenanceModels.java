...
public final class MaintenanceModels {
 ...
 public enum AttachmentCategory{REQUEST_EVIDENCE,QUOTATION,PROGRESS_EVIDENCE,INVOICE,COMPLETION_EVIDENCE}
 ...
 public record View(Long id,String workOrderNumber,long propertyId,long unitId,long requestedByUserId,Long assignedProviderServiceId,String title,String description,String category,String priority,String status,ZonedDateTime scheduledAt,ZonedDateTime completedAt,BigDecimal estimatedCost,BigDecimal actualCost,String currency,String resolutionNotes,ZonedDateTime createdOn,List<AttachmentView> attachments){
  public View(MaintenanceWorkOrder w){this(w,List.of());}
  public View(MaintenanceWorkOrder w,List<AttachmentView> attachments){this(w.getId(),w.getWorkOrderNumber(),w.getPropertyId(),w.getUnitId(),w.getRequestedByUserId(),w.getAssignedProviderServiceId(),w.getTitle(),w.getDescription(),w.getCategory(),w.getPriority(),w.getStatus(),w.getScheduledAt(),w.getCompletedAt(),w.getEstimatedCost(),w.getActualCost(),w.getCurrency(),w.getResolutionNotes(),w.getCreatedOn(),attachments);}
 }
 public record AttachmentView(Long id,long workOrderId,String category,String displayName,String contentType,long fileSize,String checksumSha256,long uploadedByUserId,ZonedDateTime createdOn,String downloadUrl){}
}
