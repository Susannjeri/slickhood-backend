...
public final class LeaseFinanceModels{private LeaseFinanceModels(){}public enum Type{DEPOSIT_RECEIVED,DEPOSIT_DEDUCTION,DEPOSIT_REFUND,LATE_FEE_CHARGED,LATE_FEE_WAIVED,CREDIT_NOTE_ISSUED,CREDIT_NOTE_APPLIED}
 ...
 public record Rule(@NotNull @DecimalMin("0.00")BigDecimal flatAmount,@NotNull @DecimalMin("0.00") @DecimalMax("100.00")BigDecimal percentageRate,@Min(0)int graceDays,@DecimalMin("0.01")BigDecimal maximumAmount,boolean enabled){}
