...
public class LandlordPlanCatalogSeedService {
    ...
    private List<String> areaFeatures(PlanCategory category) {
        return switch (category) {
            case LANDLORD -> List.of("PROPERTY_RENTALS", "ESTATE_MANAGEMENT", "PROPERTY_SALES",
                    "PROPERTY_AND_UNIT_MANAGEMENT", "LEASE_MANAGEMENT", "TENANT_ONBOARDING",
            ...
            case ESTATE_MANAGEMENT -> List.of("PROPERTY_RENTALS", "ESTATE_MANAGEMENT", "PROPERTY_SALES",
                    "ESTATE_AND_HOMEOWNER_MANAGEMENT", "SERVICE_CHARGE_BILLING",
            ...
            case PROPERTY_SALES -> List.of("PROPERTY_RENTALS", "ESTATE_MANAGEMENT", "PROPERTY_SALES",
                    "PROPERTY_LISTINGS", "BUYER_PIPELINE", "OFFERS_AND_DUE_DILIGENCE",
