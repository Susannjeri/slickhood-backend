...
public record SaleView(long id, long propertyId, String propertyName, Long unitId, String unitRef,
                       ...
                       BigDecimal escrowRequiredAmount, Long escrowInvoiceId, String currency,
                       LocalDateTime offerAcceptedAt, LocalDateTime completedAt,
    ...
    public SaleView redactInternalNotes() {
        return new SaleView(id, propertyId, propertyName, unitId, unitRef, salesAgentUserId, salesAgentName,
                buyerUserId, buyerName, buyerEmail, status, askingPrice, offerAmount,
                escrowRequiredAmount, escrowInvoiceId, currency,
