...
import static org.pms.silverocean.service.auth.roles.enums.Permission.DUPLICATE_UNIT;
...
public enum PMSPermission {
    LANDLORD_PERMISSIONS(PMSRole.LANDLORD, Set.of(CREATE_PROPERTY, EDIT_PROPERTY, VIEW_PROPERTY, DELETE_PROPERTY,
            CREATE_UNIT, EDIT_UNIT, VIEW_UNIT, DELETE_UNIT, DUPLICATE_UNIT, ADVERTISE_UNIT,
    ...
    TENANT(PMSRole.TENANT, Set.of(VIEW_PROPERTY, VIEW_UNIT, VIEW_UNIT_CHARGES,
            VIEW_UNIT_LEASE, CREATE_NEW_LEASE,
            VIEW_LANDLORD_AND_MANAGERS,
            VIEW_ACTIVE_LEASE, SIGN_LEASE, SEND_LEASE_MESSAGE, VIEW_LEASE_MESSAGE,
    ...
    PROPERTY_MANAGER(PMSRole.PROPERTY_MANAGER, Set.of(VIEW_PROPERTY, VIEW_UNIT, ADVERTISE_UNIT, VIEW_PROPERTY_PARAM, VIEW_UNIT_CHARGES,
    ...
    WORKSPACE_ADMIN(PMSRole.WORKSPACE_ADMIN, Set.of(VIEW_PROPERTY, VIEW_UNIT, ADVERTISE_UNIT, VIEW_PROPERTY_LIST, VIEW_UNIT_LIST,
    ...
    LEASING_OFFICER(PMSRole.LEASING_OFFICER, Set.of(VIEW_PROPERTY, VIEW_UNIT, ADVERTISE_UNIT, VIEW_PROPERTY_LIST, VIEW_UNIT_LIST,
    ...
    SALES_COORDINATOR(PMSRole.SALES_COORDINATOR, Set.of(VIEW_PROPERTY, VIEW_UNIT, ADVERTISE_UNIT, VIEW_PROPERTY_LIST, VIEW_UNIT_LIST,
            VIEW_SALE_PIPELINE, MANAGE_SALE_PIPELINE, VIEW_LEASE_DOCUMENT)),
    LISTING_AGENT(PMSRole.LISTING_AGENT, Set.of(VIEW_PROPERTY, VIEW_UNIT, ADVERTISE_UNIT, VIEW_PROPERTY_LIST, VIEW_UNIT_LIST,
            VIEW_SALE_PIPELINE, MANAGE_SALE_PIPELINE, VIEW_LEASE_DOCUMENT)),
    ...
    ESTATE_MANAGER(PMSRole.ESTATE_MANAGER, Set.of(CREATE_PROPERTY, EDIT_PROPERTY, VIEW_PROPERTY, DELETE_PROPERTY,
            CREATE_UNIT, EDIT_UNIT, VIEW_UNIT, DELETE_UNIT, DUPLICATE_UNIT, ADVERTISE_UNIT, VIEW_PROPERTY_LIST, VIEW_UNIT_LIST,
            CREATE_PARAM, VIEW_PARAM, EDIT_PARAM, DELETE_PARAM, DELETE_PROPERTY_PARAM, EDIT_PROPERTY_PARAM, VIEW_PROPERTY_PARAM,
            VIEW_ESTATE, MANAGE_ESTATE, CREATE_SERVICE_CHARGE, VIEW_SERVICE_CHARGE,
    ...
    HOMEOWNER(PMSRole.HOMEOWNER, Set.of(VIEW_PROPERTY, VIEW_UNIT, ADVERTISE_UNIT, VIEW_PROPERTY_LIST, VIEW_UNIT_LIST,
            ...
            VIEW_WEALTH, MANAGE_WEALTH_ASSETS, MANAGE_WEALTH_FINANCE, MANAGE_WEALTH_COMPLIANCE, MANAGE_WEALTH_VAULT, MANAGE_WEALTH_GOALS)),
    SALES_AGENT(PMSRole.SALES_AGENT, Set.of(CREATE_PROPERTY, EDIT_PROPERTY, VIEW_PROPERTY, DELETE_PROPERTY,
            CREATE_UNIT, EDIT_UNIT, VIEW_UNIT, DELETE_UNIT, DUPLICATE_UNIT, ADVERTISE_UNIT, VIEW_PROPERTY_LIST, VIEW_UNIT_LIST,
            CREATE_PARAM, VIEW_PARAM, EDIT_PARAM, DELETE_PARAM, DELETE_PROPERTY_PARAM, EDIT_PROPERTY_PARAM, VIEW_PROPERTY_PARAM,
            CREATE_ACCOUNT, EDIT_ACCOUNT, VIEW_ACCOUNT, DELETE_ACCOUNT, DECRYPT_ACCOUNT_PROPERTY,
    ...
    SUPPORT(PMSRole.SUPPORT, Set.of(Permission.VIEW_HELPDESK_QUEUE, Permission.MANAGE_HELPDESK_CASES,
            Permission.VIEW_MY_NOTIFICATIONS, Permission.VIEW_DOCUMENT_TEMPLATE_HISTORY)),
    ...
    SUPER_ADMIN(PMSRole.SUPER_ADMIN, Set.of(LIST_USERS, MANAGE_INTERNAL_STAFF, VIEW_AUDIT_LOGS, VIEW_CONFIG, EDIT_CONFIG, VERIFY_PARAM,
            ...
            VIEW_LEASE_DOCUMENT, MANAGE_LEASE_DOCUMENT_TEMPLATE, Permission.VIEW_DOCUMENT_TEMPLATE_HISTORY,
            VERIFY_SP_REFEREE, REVIEW_SP_COMPLAINT, RESOLVE_SP_COMPLAINT, BLACKLIST_SP, MANAGE_SP_CATEGORIES, VIEW_SP_PROFILE,
            VIEW_WEALTH, MANAGE_WEALTH_ASSETS, MANAGE_WEALTH_FINANCE, MANAGE_WEALTH_COMPLIANCE, MANAGE_WEALTH_VAULT, MANAGE_WEALTH_GOALS,
            MANAGE_GATE_DEVICES, VIEW_GATE_EVENTS, Permission.VIEW_HELPDESK_QUEUE,
            Permission.MANAGE_HELPDESK_CASES, Permission.MANAGE_HELPDESK_ARTICLES, Permission.MANAGE_PROPERTY_LISTINGS,
            VIEW_ESTATE, MANAGE_ESTATE, CREATE_SERVICE_CHARGE, VIEW_SERVICE_CHARGE,
            VIEW_SALE_PIPELINE, MANAGE_SALE_PIPELINE)),
    ;
