...
public record LeaseDocumentDTO(Long id, Long leaseId, Long propertyId, Long unitId,
    ...
    public LeaseDocumentDTO(LeaseDocument d) {
        this(d.getId(), d.getLeaseId(), d.getPropertyId(), d.getUnitId(), d.getDocumentType(), d.getStatus(),
