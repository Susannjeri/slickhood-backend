...
public record KycDocumentView(long id, String documentType, String status, String qualityStatus,
    ...
    static KycDocumentView from(KycDocument document, Map<String, String> extractedFields, String downloadUrl) {
        return new KycDocumentView(document.getId(), document.getDocumentType(), document.getStatus(),
